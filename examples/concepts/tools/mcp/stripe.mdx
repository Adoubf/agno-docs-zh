---
title: Stripe MCP 智能体
sidebarTitle: Stripe
---
使用 [Stripe MCP 服务器](https://github.com/stripe/agent-toolkit/tree/main/modelcontextprotocol) 创建一个可与 Stripe API 交互的智能体：
