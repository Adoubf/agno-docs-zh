---
title: Singlestore 智能体存储
sidebarTitle: Singlestore
---
Agno 支持使用 Singlestore 作为智能体的存储后端，通过 `SingleStoreStorage` 类实现。
...
- 查看[操作手册](https://github.com/agno-agi/agno/blob/main/cookbook/storage/singlestore_storage/singlestore_storage_for_agent.py)