...
本示例演示如何创建一个AI支持团队，该团队可根据咨询性质将客户请求路由至相应的智能体。
...
doc_researcher_agent = Agent(
    ...
    instructions=["You are a documentation expert for given product. Search the knowledge base thoroughly to answer user questions.",
